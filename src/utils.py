# coding: utf-8
## @package utils
# <h2>A set of useful functions and tools, used throughout the programs execution</h2>
...
# one, summing the second element of tuples whose first element matches<br>
...
## Returns the first element of a an iterable (list/tuple)
def getKey(item):
